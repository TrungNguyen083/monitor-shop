...
import com.mshop.models.ProductRating;
...
import com.mshop.models.Statistical;
import com.mshop.repositories.OrderRepository;
...
public class StatisticalRestApi {
	...
	public ResponseEntity<List<ProductRating>> getProductRating() {
		...
		List<ProductRating> list = listProductRating.stream().map(objects ->
				new ProductRating((BigInteger) objects[0], (String) objects[1], (BigInteger) objects[2], (Double) objects[3])).toList();
