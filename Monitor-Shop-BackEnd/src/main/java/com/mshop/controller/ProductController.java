...
import com.mshop.repositories.ProductResository;
...
public class ProductController {
	...
	public ResponseEntity<Void> delete(@PathVariable("id") Long id) {
		...
		Product pro = repo.findById(id).orElseThrow(() -> new RuntimeException("Not found"));
		pro.setStatus(false);
		repo.save(pro);
	...
	public ResponseEntity<List<Product>> getBestSeller() {
		return ResponseEntity.ok(repo.getBestSeller());
	}
}
